...
16. **Tap-triggered popovers** — open the "+" add-subject/add-activity popover from a button near the left edge of the screen (Today tab, Study Timer) and confirm it stays fully on-screen, not clipped past the left edge.
