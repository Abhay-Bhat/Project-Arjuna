...
// ── DevOps Career Elevation Plan — 12-Month Deliberate Learning Path ──
// Cadence: Mon / Wed / Thu / Sat · 45 min/session ≈ 3 hrs/week ≈ 12 hrs/month ≈ 144 hrs/year.
// Scores = operational depth without AI/docs help (1–10).
const DEVOPS_PLAN = [
  {
    id: 'p1', label: 'Phase 1 — Docker Foundations',
    period: 'Jul – Aug 2026 · ~20 hrs',
    color: '#4d79ff', commitment: 'Mon/Wed/Thu/Sat · 45 min/session',
    target: 'Docker: 2/10 → 4/10',
    summary: 'Architecture, volumes, networking, and multi-stage builds — the foundation everything else builds on.',
    chapters: [
      ...
      { id: 'p1_c3', code: '1.3', label: 'Docker Networking — bridge, overlay, DNS, service discovery', gap: 'HIGH' },
      { id: 'p1_c4', code: '1.4', label: 'Multi-Stage Builds & Image Layer Optimisation', gap: 'HIGH' },
    ],
    resources: [
      { label: 'Docker official docs', url: 'https://docs.docker.com', star: true },
      { label: '"Docker Deep Dive" — Nigel Poulton (Udemy)', star: true },
    ],
  },
  {
    id: 'p2', label: 'Phase 2 — Kubernetes Fundamentals',
    period: 'Sep – Oct 2026 · ~24 hrs',
    color: '#7b42bc', commitment: 'Mon/Wed/Thu/Sat · 45 min/session',
    target: 'Kubernetes: 1/10 → 3/10',
    summary: 'Pods, deployments, services, StatefulSets, and troubleshooting — the operational core of running workloads on K8s.',
    chapters: [
      { id: 'p2_c1', code: '2.1', label: 'Pods & Pod Lifecycle', gap: 'CRITICAL' },
      { id: 'p2_c2', code: '2.2', label: 'Deployments, ReplicaSets & Rolling Updates', gap: 'HIGH' },
      { id: 'p2_c3', code: '2.3', label: 'Services & Networking — ClusterIP, NodePort, Ingress', gap: 'HIGH' },
      { id: 'p2_c4', code: '2.4', label: 'StatefulSets & Persistent Volumes', gap: 'HIGH' },
      { id: 'p2_c5', code: '2.5', label: 'Troubleshooting & Debugging — describe, logs, exec', gap: 'CRITICAL' },
    ],
    resources: [
      { label: 'kubernetes.io/docs', url: 'https://kubernetes.io/docs/', star: true },
      { label: 'Kunal Kushwaha — Kubernetes YouTube playlist', url: 'https://www.youtube.com/@KunalKushwaha', star: true },
      { label: 'minikube — local hands-on cluster', url: 'https://minikube.sigs.k8s.io/docs/' },
    ],
  },
  {
    id: 'p3', label: 'Phase 3 — AWS Fundamentals',
    period: 'Nov – Dec 2026 · ~24 hrs',
    color: '#00d47c', commitment: 'Mon/Wed/Thu/Sat · 45 min/session',
    target: 'AWS: 1/10 → 2–3/10',
    summary: 'EC2, IAM, VPC, S3, and CloudWatch — the five services that show up in every AWS conversation.',
    chapters: [
      { id: 'p3_c1', code: '3.1', label: 'EC2 — Compute Basics & Instance Types', gap: 'HIGH' },
      { id: 'p3_c2', code: '3.2', label: 'IAM — Users, Roles & Policies', gap: 'CRITICAL' },
      { id: 'p3_c3', code: '3.3', label: 'VPC — Subnets, Route Tables & Security Groups', gap: 'CRITICAL' },
      { id: 'p3_c4', code: '3.4', label: 'S3 — Storage Classes & Bucket Policies', gap: 'HIGH' },
      { id: 'p3_c5', code: '3.5', label: 'CloudWatch — Metrics, Logs & Alarms', gap: 'HIGH' },
    ],
    resources: [
      { label: 'AWS Free Tier — hands-on labs', url: 'https://aws.amazon.com/free/', star: true },
      { label: '"AWS Certified Solutions Architect – Associate" (Udemy)', star: true },
    ],
  },
  {
    id: 'p4', label: 'Phase 4 — CI/CD & GitOps (GitLab Focus)',
    period: 'Jan – Feb 2027 · ~16 hrs',
    color: '#ff9933', commitment: 'Mon/Wed/Thu/Sat · 45 min/session',
    target: 'CI/CD & GitOps: 2/10 → 3–4/10',
    summary: 'Pipelines, YAML, ArgoCD, and the GitOps loop — closing the single biggest gap on the self-assessment.',
    chapters: [
      { id: 'p4_c1', code: '4.1', label: 'GitLab CI Pipelines & .gitlab-ci.yml Syntax', gap: 'CRITICAL' },
      { id: 'p4_c2', code: '4.2', label: 'Stages, Jobs, Artifacts & Caching', gap: 'HIGH' },
      { id: 'p4_c3', code: '4.3', label: 'ArgoCD & the GitOps Loop', gap: 'CRITICAL' },
      { id: 'p4_c4', code: '4.4', label: 'Hands-on: write 5–10 .gitlab-ci.yml pipelines', gap: 'HIGH' },
    ],
    resources: [
      { label: 'docs.gitlab.com — CI/CD documentation', url: 'https://docs.gitlab.com/ee/ci/', star: true },
      { label: 'ArgoCD official docs', url: 'https://argo-cd.readthedocs.io/' },
    ],
  },
  {
    id: 'p5', label: 'Phase 5 — Maintenance, Depth & Interview Drills',
    period: 'Mar – Jun 2027 · ~60 hrs',
    color: '#ff5c80', commitment: 'Mon/Wed/Thu/Sat · 45 min/session',
    target: 'Across the board: 3/10 → 4–5/10',
    summary: 'Consolidate Phases 1–4, run a full hands-on lab end-to-end, and drill interview simulations until the answers are automatic.',
    chapters: [
      { id: 'p5_c1', code: '5.1', label: 'Depth Pass — revisit Docker / K8s / AWS / CI-CD weak spots', gap: 'Sustaining' },
      { id: 'p5_c2', code: '5.2', label: 'End-to-end Lab — Dockerised app on K8s, deployed via GitLab CI/CD to AWS', gap: 'Integration' },
      { id: 'p5_c3', code: '5.3', label: 'Interview Simulation Drills — mock Q&A + STAR stories', gap: 'Closing' },
      { id: 'p5_c4', code: '5.4', label: 'System Design Practice — PACED framework walkthroughs', gap: 'HIGH' },
    ],
    resources: [
      { label: 'Revisit Phase 1–4 resources for deep-dive passes', star: true },
      { label: 'Mock interview practice (peer or AI-assisted)', star: true },
    ],
  },
];
...
const REWARD_TIERS = [
  ...
  { tier: 'Quarterly', trigger: 'Complete a full Mission Phase (Phase 0 → Phase 5).',                                reward: 'A bigger treat — a day trip, a nice dinner out, a half-day off.' },
...
const CRISIS_POINTS = [
  ...
  { crisis: 'Decision Doubt / Dubai FOMO', timing: 'Month 8–10', symptom: 'Second-guessing the India vs Dubai call; comparing your path to others’.', fix: 'Revisit the Phase 0 decision criteria — it was made with the best information available. Talk to people living both realities before changing course.' },
